...
class AdminController extends Controller
{
    ...
    public function storageLink(){
        ...
        if (file_exists($path)) {
            try {
                // If it's a symlink or file, unlink it. If directory, delete recursively.
                ...
                request()->session()->flash('error', 'Gagal menghapus existing storage: ' . $e->getMessage());
                return redirect()->back();
            }
        }
        ...
        try {
            ...
            request()->session()->flash('success', 'Storage berhasil terlink.');
        } catch (\Exception $e) {
