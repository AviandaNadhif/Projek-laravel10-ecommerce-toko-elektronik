...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Discount value will be taken from the request as provided.
        // Previously the code forced discount to 0 for certain conditions; that behavior was removed
        // so admins can set discounts for any product condition.
