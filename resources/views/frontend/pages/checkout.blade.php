                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            {{-- <label class="checkbox-inline" for="1"><input name="updates" id="1" type="checkbox"> Check Payments</label> --}}
                                                ...
                                                <label><input name="payment_method" type="radio" value="cod" required> Cash On Delivery (COD)</label><br>

                                                <label><input name="payment_method" type="radio" value="bank" id="payment_bank_radio"> Transfer Bank</label>
                                                ...
                                                <br>
                                                <label><input name="payment_method" type="radio" value="dana"> Dana</label><br>
                                                <label><input name="payment_method" type="radio" value="gopay"> Gopay</label> <br>
                                            </>
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function(){
                                                    function toggleBankSelect(){
                                                        var bankRadio = document.querySelector('input[name="payment_method"][value="bank"]');
                                                        var container = document.getElementById('bank-select-container');
                                                        var bankSelect = document.getElementById('bank-select');
                                                        if(!bankRadio || !container) return;
                                                    ...
                                                    radios.forEach(function(r){ r.addEventListener('change', toggleBankSelect); });
                                                    toggleBankSelect();
	...
	<script>
		$(document).ready(function(){
            ...
            $('.shipping select[name=shipping]').change(function(){
                ...
                // alert(coupon);
                $('#order_total_price span').text('Rp '+ formatRupiah(subtotal + cost - coupon));
            });
