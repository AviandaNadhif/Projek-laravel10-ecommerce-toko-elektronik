...
@section('title','Zyntech Enterprises || Daftar Produk')
                                    ...
                                    <ul class="categor-list">
										...
										<li>
											@foreach($menu as $cat_info)
														...
														<li><a href="{{ route('product-cat',$cat_info->slug) }}?view=lists{{ $qs ? '&'.$qs : '' }}">{{$cat_info->title}}</a>
															<ul>
																@foreach($cat_info->child_cat as $sub_menu)
																	<li><a href="{{ route('product-sub-cat', [$cat_info->slug, $sub_menu->slug]) }}?view=lists{{ $qs ? '&'.$qs : '' }}">{{$sub_menu->title}}</a></li>
																@endforeach
															</ul>
														</li>
													@else
														<li><a href="{{route('product-cat',$cat_info->slug)}}?view=lists{{ $qs ? '&'.$qs : '' }}">{{$cat_info->title}}</a></li>
													@endif
											@endforeach
										</li>
										@endif
                                ...
                                <div class="single-widget category">
                                    ...
                                    <ul class="categor-list">
										...
										@foreach($brands as $brand)
											<li><a href="{{ route('product-brand', $brand->slug) }}?view=lists{{ $qs ? '&'.$qs : '' }}">{{$brand->title}}</a></li>
										@endforeach
                                    </ul>
                                </div>
                                <!--/ End Single Widget -->
	...
	<script>
		...
		(function(){
			function setQueryParamAndReload(params){
				...
				// keep price_range and other params
