...
@section('title','Zyntech Enterprises || Beranda')
    ...
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item {{(($key==0)? 'active' : '')}}">
                    <img class="first-slide" src="{{ image_url($banner->photo) }}" alt="First slide">
                    ...
                    @if($cat->is_parent==1)
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-banner">
                                @if($cat->photo)
                                    <img src="{{ image_url($cat->photo) }}" alt="{{$cat->title}}">
                                @else
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="{{route('product-detail',$product->slug)}}">
                                                ...
                                                // dd($photo);
                                                @endphp
                                                <img class="default-img" src="{{ image_url($photo[0]) }}" alt="{{$product->title}}">
                                                <img class="hover-img" src="{{ image_url($photo[0]) }}" alt="{{$product->title}}">
                                                @if($product->stock<=0)
                ...
                @foreach($featured as $data)
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            @endphp
                            <img src="{{ image_url($photo[0]) }}" alt="{{$photo[0]}}">
                            <div class="content">
                                <p>{{$data->cat_info['title']}}</p>
                                <h3>{{$data->title}} <br>Hingga<span> {{$data->discount}}%</span></h3>
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">Rp {{ number_format($product->price,0,',','.') }}</p>
                                    </div>
                                </div>
                                </div>
                            </div>
                                            ...
                                            <div class="quickview-slider-active">
                                                ...
                                                @foreach($photo as $data)
                                                    <div class="single-slider">
                                                        <img src="{{ image_url($data) }}" alt="{{$data}}">
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
