 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
              ...
              <tr>
                <td>
                  ...
                  @endif
                    ...
                    <td>
                      @if(optional($order->shipping)->price)
                        Rp {{ number_format(optional($order->shipping)->price,0,',','.') }}
                      @else
                        -
                      @endif
                    </td>
        ...
        @else
          <h6 class="text-center">Tidak ada pesanan ditemukan!!! Silakan pesan beberapa produk</h6>
        @endif
      </div>
    </div>
</div>
