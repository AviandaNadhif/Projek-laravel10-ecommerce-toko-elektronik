...
<html>
<head>
  <title>Pesanan @if($order)- {{$order->cart_id}} @endif</title>
...
<style type="text/css">
      ...
      <h6>Tagihan kepada</h6>
       ...
       <div class="address">
        ...
        <p>
          ...
          {{ $order->address1 }} ATAU {{ $order->address2}}
        </p>
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endif --}}
        <tr>
          ...
          <th><span>
            @if(optional($order)->delivery_charge)
                Rp {{ number_format(optional($order)->delivery_charge,0,',','.') }}
            @else
                -
            @endif
          </span></th>
        ...
        <tr>
          ...
          <th>
            <span>
                @if(optional($order)->total_amount)
                    Rp {{ number_format(optional($order)->total_amount,0,',','.') }}
                @else
                    -
                @endif
            </span>
  ...
  <div class="thanks mt-3">
    <h4>Terima kasih atas bisnis Anda !!</h4>
  </div>
  <div class="authority float-right mt-5">
    <p>-----------------------------------</p>
    <h5>Tanda Tangan Berwenang:</h5>
  </div>
  <div class="clearfix"></div>
@else
